...
class AsAffine(TransformedDistribution):
...
#     return super(AffineTransform, self)._log_prob(x)

#   @distribution_util.AppendDocstring(_mvn_sample_note)
#   def _prob(self, x):
#     return super(AffineTransform, self)._prob(x)
