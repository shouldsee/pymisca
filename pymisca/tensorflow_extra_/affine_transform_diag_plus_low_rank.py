...
__all__ = [
    "AffineTransformDiagPlusLowRank",
]


class AffineTransformDiagPlusLowRank(
    AsAffine):
  ...
  * `scale_perturb_diag.shape = [r]`.
  ...
  def __init__(self,
               ...
               name="AffineTransformDiagPlusLowRank"):
...
#           scale = linalg.LinearOperatorUDVHUpdate(
              ...
              is_square=True)
    super(AffineTransformDiagPlusLowRank, self).__init__(
